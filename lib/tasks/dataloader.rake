...
namespace :enzymedb do
  ...
  task :production_tags, :needs => :environment do |t,args|
    tags = {
      'healthy_human' => "select * from glycodbs where species = 'HOMO SAPIENS' and (recombinant = 'HOMO SAPIENS' or recombinant = 'none' or recombinant = '') and (disease = '' or disease is null)",
